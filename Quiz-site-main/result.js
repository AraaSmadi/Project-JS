...
function Show() {
    ...
    btn.onclick = function() {
        window.location.href =
            "http://127.0.0.1:5500/Quiz-site-main/finish.html";
    };
...
if (counter >= 10) {
    ...
    document.getElementById("btn").style.backgroundColor = "#009879";
    ...
    btn.onclick = function() {
        window.location.href = "http://127.0.0.1:5500/Quiz-site-main/finish.html";
    };
} else {
